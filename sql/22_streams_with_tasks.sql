...
CREATE OR REPLACE TASK STREAMS_DB.PUBLIC.ALL_DATA_CHANGES;
...
SET PRODUCT = 'Chocolate bar new'
WHERE PRODUCT ='Chocolate bar';
...
DROP TASK STREAMS_DB.PUBLIC.ALL_DATA_CHANGES;